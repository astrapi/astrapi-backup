...
from astrapi_backup.modules.borg.jobs import preview as _preview_borg
...
_SCHEMA_PATH = Path(__file__).parent.parent / "config" / "schema.yaml"
api_router = make_htmx_crud_router(
    KEY, _SCHEMA_PATH, preview_fn=_preview_borg, running_fn=get_running
)
