    ...
    ui_content=ContentTable(
        ...
        columns=[
            Col.badge_list(
                ...
                "Typen",
                {
                    "borg_source": {"label": "Borg Source", "cls": "badge-blue"},
                    "borg_target": {"label": "Borg Target", "cls": "badge-blue"},
                    "rsync": {"label": "Rsync", "cls": "badge-blue"},
                    "proxmox_node": {"label": "Proxmox Node", "cls": "badge-amber"},
                    "proxmox_client": {"label": "Proxmox Client", "cls": "badge-amber"},
                    "proxmox_backup": {"label": "Proxmox Backup", "cls": "badge-grey"},
                },
            ),
