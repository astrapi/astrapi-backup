...
def create_modal():
    ...
    return render_template(
        ...
        schema=_resolve_fields(schema["fields"]), item=None, method="post", title="Neu",
...
def edit_modal(item):
    ...
    return render_template(
        "partials/create_edit/create_edit_modal.html",
        schema=_resolve_fields(schema["fields"]), item=values, method="patch", title=f"Bearbeiten: {item}",
        submit_url=submit_url, container_id=container_id, loading_id=loading_id,
    )
