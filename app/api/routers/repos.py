...
def repos_tab(request: Request):
    ...
    return templates.TemplateResponse("partials/repos/tab.html", {
        "request": request,
        "repos": repos,
    })
...
def repo_info(request: Request, repo_id: int):
    ...
    return templates.TemplateResponse("partials/repos/info_modal.html", {
        "request":    request,
        "repo":       repo,
        "info":       info,
...
def repo_create_modal(request: Request):
    ...
    return templates.TemplateResponse("partials/repos/create_modal.html", {
        "request":              request,
...
def repo_edit_modal(request: Request, repo_id: int):
    ...
    return templates.TemplateResponse("partials/repos/edit_modal.html", {
        "request": request,
        "repo": repo,
...
def repo_delete_modal(request: Request, repo_id: int):
    ...
    if not repo:
        return HTMLResponse("<p>Repo nicht gefunden.</p>", status_code=404)
    return templates.TemplateResponse("partials/repos/delete_modal.html", {
        "request": request,
        "repo": repo,
    })
