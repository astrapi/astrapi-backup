...
def browser_tab(request: Request):
    return templates.TemplateResponse("partials/browser/tab.html", {
        "request": request,
        "repos":   list_repos(),
    })
...
def browser_archives(request: Request, repo_id: int):
    ...
    try:
        ...
        archives = []
        error = str(e)
    return templates.TemplateResponse("partials/browser/archives.html", {
        "request":  request,
        "repo":     repo,
        "archives": archives,
        "error":    error,
...
def browser_browse(request: Request, repo_id: int, archive: str, path: str = ""):
    ...
    if not entries and not cur:
        return templates.TemplateResponse("partials/browser/browse.html", {
