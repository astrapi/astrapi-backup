...
def _run(item_id: str, entry: dict, lock: threading.Lock) -> None:
    try:
        ...
        from backupctl.modules.borg.api import _get_target_info, _list_archives, _load_archive_entries, _repo_info
        from backupctl.modules.borg.utils import borg_env as _borg_env
