...
from backupctl.api.storage import get_item
from backupctl.modules.borg.storage import (
...
from backupctl.modules.borg.utils import borg_bin as _borg_bin, borg_env as _borg_env
from backupctl.modules.borg.jobs import preview as _preview_borg, _get_host_info as _job_get_host_info
...
def refresh_archives(item_id: str, request: Request):
    ...
    if not live_error and archives:
        ...
        from backupctl.modules.borg import cache as _borg_cache
