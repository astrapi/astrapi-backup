...
from backupctl.api.storage import load_config as _load_config, get_entry as _get_entry, patch_item as _patch_item
...
def _get_proxmox_host_info(entry: dict) -> tuple[str, str, int, str]:
    ...
    if remote_id:
        from backupctl.modules.remotes.engine import get_remote_ssh, get_remote
        try:
